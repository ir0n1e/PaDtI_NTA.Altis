...
// =========================================================================================================
format ["TaskTest isHC: %1 isServer: %2", !(isServer && hasinterface), isserver] call NTA_fnc_log;
...
_nearlocations = [_position,2000] call PO3_fnc_getNearbylocations;
...
[ format["TASK%1",PO3_TASK__IDD],
	format[localize "STR_PO3_M02_TITLE",_locaname],
	format[localize "STR_PO3_M02_DESCR",PO3_TASK__IDD,_locaname],
	(PO3_side_1 select 0),
