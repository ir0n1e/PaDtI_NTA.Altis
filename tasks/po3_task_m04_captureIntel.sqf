...
// =========================================================================================================
	...
	[ format["TASK%1",PO3_TASK__IDD],
		...
		format[localize "STR_PO3_M04_DESCR",PO3_TASK__IDD,_locaname,_numIntel,(PO3_side_3 select 2)],
		(PO3_side_1 select 0),
		[format["MRKR%1",PO3_TASK__IDD],_position,"mil_objective","ColorOPFOR",localize "STR_PO3_M04_TITLE"],
		"assigned",
		(_position),
		localize "STR_PO3_M04_TITLE"
