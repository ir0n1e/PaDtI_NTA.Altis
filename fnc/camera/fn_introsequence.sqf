if (local player) then {
	...
	_sitrep = "|{P}a}t}r}o}l} {A}n}d} {D}o}m}i}n}a}t}e} {t}h}e} {I}s}l}a}n}d} |{M}i}x} }a}u}s} {P}a}t}r}o}l} {O}p}s},} {D}o}m}i}n}a}t}i}o}n},} {C}T{I}";
	...
	_sitrep = "";
	_textSize = 3;
	_control ctrlsetstructuredtext parsetext format ["<img size='4' color='#ffffff' image='pics\NTA_Logo_G.paa'/>"];
	...
	for "_i" from 0 to (count _sitrepArray - 1) do {
		...
		_delay = switch ( _letter) do {
			...
			case "{" : { _letter = format["<t color='#3399FF' size='%1'>",_textSize]; 0.05 };
