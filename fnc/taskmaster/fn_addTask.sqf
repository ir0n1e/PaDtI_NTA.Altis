...
*/
if (!PO3SRV) exitWith{
	[_this, "PO3_fnc_addTask", false, false] call bis_fnc_mp;
};
private ["_name","_short","_long","_cond","_marker","_state","_dest","_chev","_briefing"];
...
_briefing = format ["<t align='center' size='2.2' color='#357EC7'>%1</t><br/><br/>____________________<br/>%3<br/><br/><t size='1.1'>%2<br/>%3</t>",_short,_long,_cond];
