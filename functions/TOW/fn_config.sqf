...
dll_tow_search_radius = 1000; //vehicles within this radius are searched for suitability. Too large may take a long time to init (??).
...
dll_tow_defs =   [["TowingTractor",       nil,     nil,       [0.25, -2], false],
                  ...
                  ["Fennek_Flecktarn",          nil,nil,       [0, -0.1],   false],
                  ["eslinga",          [0,8],     [0,-0.1],       [0, -4],   false],
                   ["Fennek_Flecktarn_mg",          [0,5.5],     [0,-0.1],       nil,   false],
                  ["Fennek_Flecktarn_gmg",          [0,5.5],     [0,-0.1],       nil,   false],
                  ...
                  ["B_Plane_CAS_01_F", [0,7], [0,-1], nil,        false],
                  ["Fighter",             [0,7],   [0,-1],   nil,         false],
                  ["Helicopter",          [0,7],   [0,-1],   nil,         false],
                  ["B_Heli_Transport_01_camo_F", [0,12.5],[0,-1],nil,         true],
