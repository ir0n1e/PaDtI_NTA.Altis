...
_actionsVar = player getVariable ["AGM_SelfInteractions", [-1, [], []]];
...
_actions pushBack [_displayName, 0,_condition, _statement, _showDisabled, _priority];

player setVariable ["AGM_SelfInteractions", [_id, _actionIDs, _actions], false];
_id