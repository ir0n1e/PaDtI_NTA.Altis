...
private ["_grp","_grp1","_grp2","_grp3","_grp4","_objectlist",
...
PO3_TASK__POS	= getmarkerpos "town";
...
_null=[leader _group1,_marker,"random",  "min:",1,"max:",1,"ambush" ] execVM "scripts\UPSMON.sqf";
...
_null=[leader _group2,_marker,"random",  "min:",1,"max:",1,"ambush" ] execVM "scripts\UPSMON.sqf";
...
_null=[leader _grp,_marker,"random","delete:",120,  "min:",4,"max:",4] execVM "scripts\UPSMON.sqf";
...
_null=[leader _grp,_marker,"delete:",120,"random", "fortify", "min:",4,"max:",4] execVM "scripts\UPSMON.sqf";


_pos = [20102.929688,11755.605469,0.019104];
_heli1 = createVehicle ["O_Heli_Attack_02_F", _pos, [], 0, "CAN_COLLIDE"];
_objectlist pushback _heli1;
_heli1 setDir 0;
...
_null=[leader _grp4,_marker_town,"nowp"] execVM "scripts\UPSMON.sqf";
