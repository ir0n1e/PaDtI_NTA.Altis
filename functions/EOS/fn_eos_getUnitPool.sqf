...
switch (_type) do {
	case 0: {
		for "_i" from 0 to 5 do{
			_unit = _InfPool call NTA_fnc_getRandArrayPos;
	...
	// CREATE ARMOUR & CREW
	case 2: {
		_crew		= _crewPool call NTA_fnc_getRandArrayPos;
		_tempUnit 	= _ArmPool call NTA_fnc_getRandArrayPos;
	...
	case 3: {
		_crew 		= _heliCrew call NTA_fnc_getRandArrayPos;
		_tempUnit 	= _ACHPool call NTA_fnc_getRandArrayPos;
	...
	case 4: {
		_crew =		_heliCrew call NTA_fnc_getRandArrayPos;
		_tempUnit =	_CHPool call NTA_fnc_getRandArrayPos;
	...
	case 5: {
		_crew		= _crewPool call NTA_fnc_getRandArrayPos;
		_tempUnit	= _stPool call NTA_fnc_getRandArrayPos;

		_temparray pushback _tempUnit;
		_temparray pushback _crew;
	};
	case 6: {
		_tempArray = _uavPool call NTA_fnc_getRandArrayPos;
	};
	// CREATE TRANSPORT & CREW
	case 7: {
		_crew		= _crewPool call NTA_fnc_getRandArrayPos;
		_tempUnit	= _MotPool call NTA_fnc_getRandArrayPos;
	...
	case 8: {
		_tempUnit 	= _shipPool call NTA_fnc_getRandArrayPos;
		_crew 		= _diverPool call NTA_fnc_getRandArrayPos;
	...
	case 10: {
		for "_i" from 0 to 4 do{
			_unit = _diverPool call NTA_fnc_getRandArrayPos;
			_temparray pushback _unit;
		};
	};
};
